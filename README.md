# 💻 AGH University Labs & Projects

**[PL]** Witaj! Jestem studentem Informatyki i Systemów Inteligentnych na AGH. Niniejsze repozytorium stanowi zbiór moich projektów akademickich, zadań laboratoryjnych oraz mniejszych skryptów tworzonych w toku studiów. Choć nie jest to jeden spójny system, repozytorium to dobrze obrazuje mój rozwój techniczny oraz technologie, które aktualnie opanowuję i wykorzystuję w praktyce.

**[EN]** Welcome! I am a Computer Science and Intelligent Systems student at AGH University. This repository serves as a collection of my academic projects, lab assignments, and scripts developed during my studies. Rather than a single enterprise system, it acts as a technical sandbox reflecting my ongoing learning process and the tech stack I am currently mastering.
...
📦 AGH-Labs-Projects
 ...
 ┃ ┗ 📜 README.md
 ┣ 📂 C++
 ┃ ┣ 📂 pp2-lab9-sorted-unique...
 ┃ ┣ 📂 pp2-lab10-ptr-c-string...
 ┃ ┗ 📜 README.md
 ┣ 📂 Data engineering
 ┃ ┣ 📂 lab3
 ┃ ┣ 📂 lab5
 ...
 ┃ ┣ 📜 Inżynieria_oprogramowania.pdf
 ┃ ┗ 📜 README.md
 ┣ 📂 LaTeX
 ┃ ┣ 📜 SprawozdanieLaTeX.pdf
 ┃ ┣ 📜 SprawozdanieLaTeX.tex
 ┃ ┗ 📜 README.md
 ┣ 📂 Machine learning
 ┃ ┣ 📜 lab03.py
 ┃ ┣ 📜 lab04.py
